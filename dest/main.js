...
function handleDropDownLanguage() {
  ...
  const dropDownLang = ctaLang.querySelectorAll(".dropdownlang .dropdownlang__item");
...
function handleHeroSlider() {
  ...
  if (heroSlider !== null && typeof heroSlider !== "undefined") {
    ...
    const nextBtn = document.querySelector(".schero__slider-controls .btncontrolgroup .--arrowright");
    const prevBtn = document.querySelector(".schero__slider-controls .btncontrolgroup .--arrowleft");
    const numTotalPage = document.querySelector(".schero__slider-controls .paging .paging__total");
    const numCurrentPage = document.querySelector(".schero__slider-controls .paging .paging__current");
    ...
    heroSliderFlickity.on("change", (currentPageIndex) => {
      numCurrentPage.innerText = (currentPageIndex + 1).toString().padStart(2, "0");
    });
  }
}
handleHeroSlider();
...
function handleProjectSlider() {
  ...
  if (selectedProjectSlider !== null && typeof selectedProjectSlider !== "undefined") {
    const numTotalPage = document.querySelector(".scprojects__textbox .paging .paging__total");
    const numCurrentPage = document.querySelector(".scprojects__textbox .paging .paging__current");
...
function handleTestimonialCarousel() {
  const testimonialCarousel = document.querySelector(".sctestimonial__carousel");
...
function handleBtnControlsPadding() {
  function btnControlPadding() {
    ...
    if (heroControls !== null && typeof heroControls !== "undefined") {
      const containerWidth = document.querySelector(".scservice .container").clientWidth;
      if (windowWidth >= 1920) {
...
function handleFormAdvise(submitSucess) {
  ...
  const adviseForm = document?.querySelector(".scadvise .scadvise__inner .scadvise__form");
      ...
      if (key === "consultation") {
        ...
        if (key === "phonenumber") {
          if (!!!validatePhoneNumber(userData[key]) && userData[key] !== "") {
            input.nextElementSibling.innerText = "Wrong phone number format. Example format: 0356668351";
...
function handleNavbar() {
  ...
  if (btnNav !== null && typeof btnNav !== "undefined") {
    ...
    navMenu.querySelector(".header__navmobile").addEventListener("click", (e) => {
      e.stopPropagation();
    });
    ...
    document.addEventListener("click", () => {
      const headerNavMobileItemDropDownIconList = document.querySelectorAll(".header__navmobile-item .title .title__icon");
...
function handleFlickityAbilityList() {
  const abilityLlist = document.querySelector(".scintro .scintro__content .scintro__content-right .abilitylist");
...
function handleTitleServiceContentSection() {
  const serviceSectionContainer = document.querySelector(".scservicecontent .container");
  const titleFirstItem = document.querySelector(".scservicecontent__title.--h2");
  if (titleFirstItem !== null && typeof titleFirstItem !== "undefined") {
    if (window.innerWidth <= 991.98) {
      const firstItemTextbox = document.querySelector(".scservicecontent__groups .scservicecontent__groups-item .textbox");
      firstItemTextbox.insertAdjacentElement("afterbegin", titleFirstItem);
    } else {
      serviceSectionContainer.insertAdjacentElement("afterbegin", titleFirstItem);
    }
  }
}
...
// TODO13: Dropdown for project section
function handleDropDownProject(btnDropDown, dropDownList, articleList, paddingRight = "245px") {
  const dropDownListLastItemBottomPos = dropDownList.lastElementChild.getBoundingClientRect().bottom;
  ...
  btnDropDown.addEventListener("click", () => {
    ...
    if (dropDownList.classList.contains("--active")) {
      ...
      if (window.innerWidth > 991.98) {
        btnDropDown.parentElement.parentElement.style.paddingRight = paddingRight;
        articleList.style.marginTop = `${dropDownListLastItemBottomPos - articleListTopPos + 28}px`;
      }
    } else {
...
const btnDropDownProject = document.querySelector(".sclastprojects .sclastprojects__textbox .sclastprojects__textbox-dropdown .dropdowngroup .dropdowngroup__current");
if (btnDropDownProject !== null && typeof btnDropDownProject !== "undefined") {
  const dropDownListProject = document.querySelector(".sclastprojects .sclastprojects__textbox .sclastprojects__textbox-dropdown .dropdowngroup .dropdowngroup__list");
  const articleListProject = document.querySelector(".sclastprojects .sclastprojects__articlelist");
  handleDropDownProject(btnDropDownProject, dropDownListProject, articleListProject);
}

const btnDropDownProjectDetail = document.querySelector(".scprojectsdemo .scprojectsdemo__textbox .scprojectsdemo__textbox-dropdown .dropdowngroup .dropdowngroup__current");
if (btnDropDownProjectDetail !== null && typeof btnDropDownProjectDetail !== "undefined") {
  const dropDownListProjectDetail = document.querySelector(".scprojectsdemo .scprojectsdemo__textbox .scprojectsdemo__textbox-dropdown .dropdowngroup .dropdowngroup__list");
  const articleListProjectDetail = document.querySelector(".scprojectsdemo .scprojectsdemo__gallery");
  handleDropDownProject(btnDropDownProjectDetail, dropDownListProjectDetail, articleListProjectDetail);
}

const btnDropDownNews = document.querySelector(".scnews .scnews__textbox .scnews__textbox-dropdown .dropdowngroup .dropdowngroup__current");
if (btnDropDownNews !== null && typeof btnDropDownNews !== "undefined") {
  const dropDownListNews = document.querySelector(".scnews .scnews__textbox .scnews__textbox-dropdown .dropdowngroup .dropdowngroup__list");
  const articleListNews = document.querySelector(".scnews .sclastprojects__articlelist");
  handleDropDownProject(btnDropDownNews, dropDownListNews, articleListNews, "308px");
}

const btnDropDownVideo = document.querySelector(".scvideo .scvideo__textbox .scvideo__textbox-dropdown .dropdowngroup .dropdowngroup__current");
if (btnDropDownVideo !== null && typeof btnDropDownVideo !== "undefined") {
  const dropDownListNews = document.querySelector(".scvideo .scvideo__textbox .scvideo__textbox-dropdown .dropdowngroup .dropdowngroup__list");
  const articleListNews = document.querySelector(".scvideo .sclastprojects__articlelist");
  handleDropDownProject(btnDropDownVideo, dropDownListNews, articleListNews, "308px");
}

// TODO14: Project detail carousel
function handleProjectCarousel() {
  const projectGalleryFancyBox = document?.querySelector("#scprojectsdemo__gallery");
  if (projectGalleryFancyBox !== null && typeof projectGalleryFancyBox !== "undefined") {
...
function handleVideoPopUp() {
  ...
  const articleThumbs = document?.querySelectorAll(".scvideo .sclastprojects__articlelist .sclastprojects__articlelist-group .article .thumb");
  const articleHeading = document?.querySelectorAll(".scvideo .sclastprojects__articlelist .sclastprojects__articlelist-group .article .textbox .heading");
  const articleBtnWatchVideo = document?.querySelectorAll(".scvideo .sclastprojects__articlelist .sclastprojects__articlelist-group .article .textbox .btnreadpost");
  ...
  function handleShowVideo(elem) {
    elem.addEventListener("click", (e) => {
      ...
      videoPopUpIframe?.setAttribute("src", `https://www.youtube.com/embed/${videoId}?autoplay=1`);
  ...
  articleHeading.forEach((heading) => {
    const videoId = heading.parentElement.previousElementSibling.getAttribute("data-video-id");
    heading.setAttribute("data-video-id", videoId);
    handleShowVideo(heading);
  });

  articleBtnWatchVideo.forEach((btn) => {
    const videoId = btn.parentElement.previousElementSibling.getAttribute("data-video-id");
